...
const Navbar = () => {
  return (
    <div className="bg-[#0B1A4A] h-[80px] w-full lg:flex hidden md:block md:text-center justify-around items-center fixed pl-20 pr-20 z-50 top-0 border-b border-gray-700">
      ...
      <div className="w-[100%] font-Muli lg:justify-end md:justify-center flex text-[#9FA6C0] md:pt-5 lg:pt-0">
        <div className="flex-initial w-32 hover:text-[#FFFF]">
          <a
            className="text-[14px]"
            href="https://www.facebook.com/groups/532055499048261"
          >
            FACEBOOK
          </a>
        </div>

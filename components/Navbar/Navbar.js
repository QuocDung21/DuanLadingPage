...
const Navbar = () => {
  return (
    <div className="bg-[#0B1A4A] h-[80px] w-full lg:flex hidden md:block md:text-center justify-around items-center border-2 fixed pl-20 pr-20 z-10 top-0 border-b border-slate-600">

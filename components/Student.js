...
const Student = () => {
  return (
    <div className="bg-[#0B1A4A] text-white " >
      <div className="container mr-auto ml-auto items-center relative lg:max-w-[1140px] lg:min-h-[800px] " >
        ...
        <div className="flex flex-col lg:flex-row justify-evenly  lg:justify-between items-left gap-5 py-5  ">
          ...
          <div className="flex flex-col lg:flex-col justify-evenly  gap-5 py-5 ">
            <p className="text-3xl lg:text-3xl font-medium capitalize lg:pl-[20px] text-center ">
            ...
            <div className="grid lg:gap-4 lg:grid-cols-2 lg:grid-rows-2 md:gap-4 md:grid-cols-2 md:grid-rows-2 lg:text-left md:text-center text-center lg:pr-[30px]">
              <div className="flex flex-col ">
                ...
                <span className="text-xl md:text-3xl lg:text-3xl py-3 font-medium" >Nguồn Điện</span>
              ...
              <div className="flex flex-col ">
                ...
                <span className="text-xl md:text-3xl lg:text-3xl py-3 font-medium">Lắp Đặt Đúng Cách</span>
              ...
              <div className="flex flex-col ">
                ...
                <span className="text-xl md:text-3xl lg:text-3xl py-3 font-medium">An Toàn Pin</span>
              ...
              <div className="flex flex-col ">
                ...
                <span className="text-xl md:text-3xl lg:text-3xl py-3 font-medium">Bảo Dưỡng</span>
